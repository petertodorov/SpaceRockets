...
var Smoothie = function () {
  ...
  _createClass(Smoothie, [{
    ...
    value: function gameLoop(timestamp) {
      ...
      if (!this.paused) {
        ...
        var interpolate = function interpolate() {
          ...
          var elapsed = current - _this._startTime;
    ...
    value: function render() {
      ...
      var lagOffset = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
      ...
      if (this.interpolate) {
        ...
        var restoreSpriteProperties = function restoreSpriteProperties(sprite) {
          ...
          if (sprite.children.length !== 0) {
            for (var _i = 0; _i < sprite.children.length; _i++) {
              // Find the sprite's child
              var child = sprite.children[_i];
        ...
        for (var _i2 = 0; _i2 < this.stage.children.length; _i2++) {
          var _sprite = this.stage.children[_i2];
          restoreSpriteProperties(_sprite);
        }
      }
    }
  }, {
